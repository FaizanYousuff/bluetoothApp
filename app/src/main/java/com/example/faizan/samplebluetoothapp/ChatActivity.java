...
public class ChatActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final UUID UUIDS= UUID.fromString("e3501982-6d1a-4324-ba54-c87682135de6");
    ...
    private boolean isCameraAllowed() {
        ...
        int result = ContextCompat.checkSelfPermission(ChatActivity.this, Manifest.permission.CAMERA);
 ...
 Handler handler = new Handler(new Handler.Callback() {
    ...
    private class ClientCLass extends Thread{
        ...
        public ClientCLass(BluetoothDevice device1){
            device= device1;
            try {
                Toast.makeText(ChatActivity.this, device1.getAddress(), Toast.LENGTH_SHORT).show();
                Toast.makeText(ChatActivity.this, device1.getName(), Toast.LENGTH_SHORT).show();
